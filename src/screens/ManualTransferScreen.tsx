...
export function ManualTransferScreen() {
  ...
  const isLowConfidence =
    aiConfidence !== null && aiConfidence < LOW_CONFIDENCE_THRESHOLD;

  const [recipientName, setRecipientName] = useState(
    prefilled?.prefilledRecipient ?? "",
  );
  const [accountNum, setAccountNum] = useState(
    prefilled?.prefilledAccount ?? "",
  );
  const [selectedBank, setSelectedBank] = useState(
    prefilled?.prefilledBank ?? "",
  );
      ...
      <Modal visible={showPinModal} transparent animationType="slide">
        <View style={styles.pinModalOverlay}>
          <View style={[styles.pinModalCard, shadows.cardLg]}>
            ...
            <View style={styles.keypadGrid}>
              {[
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.keypadBtn,
                    key === "BIO" && styles.keypadSpecialBtn,
                  ]}
            ...
            <TouchableOpacity
              style={styles.pinUssdBtn}
              onPress={handleUssdFallback}
              activeOpacity={0.75}
            >
          ...
          <View style={[styles.processingCard, shadows.cardLg]}>
            ...
            <View style={styles.processingStepsBox}>
              <View style={styles.stepRow}>
                <Icon
                  name={
                    processStep >= 1 ? "checkmark-circle" : "radio-button-off"
                  }
                  size={16}
                  color={
                    processStep >= 1 ? colors.successGreen : colors.textMuted
                  }
                />
                <Text
                  style={[
              ...
              <View style={styles.stepRow}>
                <Icon
                  name={
                    processStep >= 2 ? "checkmark-circle" : "radio-button-off"
                  }
                  size={16}
                  color={
                    processStep >= 2 ? colors.successGreen : colors.textMuted
                  }
                />
                <Text
                  style={[
              ...
              <View style={styles.stepRow}>
                <Icon
                  name={
                    processStep >= 3 ? "checkmark-circle" : "radio-button-off"
                  }
                  size={16}
                  color={
                    processStep >= 3 ? colors.successGreen : colors.textMuted
                  }
                />
                <Text
                  style={[
...
const styles = StyleSheet.create({
  ...
  fixedFromWrap: {
    ...
    borderWidth: 1,
    borderColor: "rgba(74, 29, 122, 0.2)",
    borderRadius: radius.lg,
