...
export function VerificationScreen() {
      ...
      setRows((prev) =>
        prev.map((r) =>
          r.id === editId
            ? {
                ...r,
                item: editVals.item || r.item,
                qty,
                price: `₦${price.toLocaleString()}`,
                amount: `₦${computed.toLocaleString()}`,
              }
            : r,
        ),
      );
  ...
  const addRow = () => {
    ...
    setRows((prev) => [
      ...prev,
      { id: newId, item: "New item", qty: 1, price: "₦0", amount: "₦0" },
    ]);
  ...
  return (
    <View style={styles.root}>
      ...
      >
                ...
                {isEditing ? (
                  ...
                  <>
                    ...
                    <TextInput
                      ...
                      onChangeText={(v) =>
                        setEditVals((p) => ({ ...p, qty: parseInt(v) || 0 }))
                      }
                    ...
                    <TextInput
                      style={[
                        styles.editInput,
                        { flex: 1.25, textAlign: "right" as const },
                      ]}
                      value={editVals.price}
                      onChangeText={(v) =>
                        setEditVals((p) => ({ ...p, price: v }))
                      }
                      keyboardType="numeric"
                    />
                    <Text
                    ...
                    >
                      ₦
                      {(
                        (editVals.qty ?? 0) * parseN(editVals.price ?? "0")
                      ).toLocaleString()}
                    </Text>
        ...
        {/* Confirm CTA */}
        <TouchableOpacity
          style={[styles.confirmBtn, shadows.button]}
